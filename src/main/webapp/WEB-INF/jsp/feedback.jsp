...
<body>
 ...
 <div class="row no-gutters">
     <div class="col-md-10">
 <h2 class="card-title text-center" style="color:#E0115F;">Add-feedback</h2>
<form action="${pageContext.request.contextPath}/processFeedback/${blogId}" method="post">
...
<input type="text" name="text" class="form-control white-placeholder" placeholder="Comment" />
        ...
        <button type="submit"style="width: 130px; height: 50px; border-color: #E0115F;font-size:15px; font-weight: bold; color: black; background-color: #E0115F; border-radius: 20px;">Save</button>
    </form>
