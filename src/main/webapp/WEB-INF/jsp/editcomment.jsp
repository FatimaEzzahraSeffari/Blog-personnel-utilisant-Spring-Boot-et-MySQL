...
<div class="container">
    ...
    Edit-Comment
                                ...
                                <form action="${pageContext.request.contextPath}/editcomment/${comment.id}" method="post">  
 ...
 <div class="form-group ">
                ...
                <input type="text" name="name" class="form-control white-placeholder" placeholder="Name:"value="${comment.name}" />
                  </div>
 <div class="form-group ">
            
                <label class="col-2 col-form-label"style="color:#E0115F;font-weight: bold;font-size:18px;">Image URL: </label>
                 
               
                <input type="text" name="image" class="form-control white-placeholder" placeholder="image" value="${comment.image}"/>
                 </div>
 <div class="form-group ">
                <label class="col-2 col-form-label"style="color:#E0115F;font-weight: bold;font-size:18px;">Profession: </label>
                
               
                <input type="text" name="profession" class="form-control white-placeholder" placeholder="Profession"value="${comment.profession}" />
                  </div>
 <div class="form-group ">
            
                <label class="col-2 col-form-label"style="color:#E0115F;font-weight: bold;font-size:18px;">Comment: </label>
                 
               
<input type="text" name="text" class="form-control white-placeholder" placeholder="Comment" value="${comment.text}"/>
                </div>
 <div class="form-group ">
