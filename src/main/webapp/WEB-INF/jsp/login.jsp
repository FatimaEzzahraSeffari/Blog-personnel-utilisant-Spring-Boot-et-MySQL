...
<body>
 ...
 <div class="row no-gutters">
     <div class="col-md-10">
     <h2 class="card-title text-center" style="color:#E0115F;">User Login - Sign In</h2>
        <form action="${pageContext.request.contextPath}/processlogin" method="post">
            <div class="m-3">
                ...
                <div>
                 ...
                 <center>
                    <button type="submit" class="btn btn-primary"style="width: 130px;border-color: white;font-weight: bold;color:black;">Login</button>
                 </center>
                </div>
            </div>
        </form>
